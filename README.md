...
└─$ neofetch
     ...
     JS^\__/  qKL                 Uptime: since 2024
    dZP        qKRb               Shell: bash
   dZP          qKKb              Terminal: GNOME Terminal
  fZP            SMMb             DE: Backend Systems
  HZM            MMMM             WM: REST APIs
...
Also        : Kotlin, Android, C++
Interested  : Linux, Backend Systems, APIs, System Design
